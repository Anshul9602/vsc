                ...
                <div class=" row col-md-8 mt-md-3 mb-md-3 mb-0 mt-0">
                    <div class="col-lg-3 col-md-6 col-6  mt-2  tc">
                        <div class="div-block-1463">
                            ...
                            <p class="str" style="height:2px; width:70px;background:#4494D4;"></p>
                        </div>
                        ...
                        <div class="col-footer">
                                ...
                                <div class="info mt-4 col-md-12 text-white row">
                                    <div class="address row col-md-12 m-0" style="align-items: center;">
                                        ...
                                        <p class="col-md-10 col-10 p-0">Office 222 , 2nd floor , Ganpati Plaza , M.I. Road, Jaipur-302001, Rajasthan</p>
                                    </div>

                                    <div class="email row col-md-12 m-0 pt-md-0 pt-2"style="align-items: center;">

                                        <h6 class="col-md-2 col-2" style="font-weight: 700;"><span><i class="bi bi-globe-americas"></i>
                                                &nbsp;</span></h6>
                                        <p class="col-md-10 col-10 p-0"> www.vsc.co.in
                                        </p>
                                    </div>
                                    <div class="phone row col-md-12 col-12 m-0 pt-md-0 pt-2"style="align-items: center;">
                                        ...
                                        <p class="col-md-10 col-10 p-0" style="color:#fff !important;">
                                            <a href=""style="color:#fff !important;">0141-2389290</a><br></p>
                                    </div>
                                </div>
