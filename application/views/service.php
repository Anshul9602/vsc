...
<section style="background-color: #35383d;">
  <div class="container">
    <div class="row">
      <div class="col-md-6 text-white">
        <h1>LENDING CRITERIA</h1>
        <p class="mt-4" style="height: 3px;width:20%;background:#fff;"></p>
        <div class="contant mt-4">
          <h4 style="font-weight: 500;">HIGH LEVERAGE BRIDGE PROGRAM</h4>
          <p>Leverage Up to 75% of Value</p>
          <p>Rate: Starting at 8% Interest Only</p>
          <p>Closing: 1-3 Weeks</p>
          <p>Non-Recourse: Available</p>
          <p>Loan Size: $2MM – $30MM</p>
          <p>Term: Up to 24 Months</p>
          <p>Property Types: Multifamily, Retail, Office, Industrial, Non-Owner Occupied SFR,</p>
          <p>Urban Infill Land</p>
          <p>Second Trust Deeds Available</p>
          <p>Markets: CA, AZ, TX, FL, OR, CO, ID, UT, WA, TN, NC, GA, PA, MA, DC, MD, VA, IL</p>
        </div>

      </div>
      <div class="col-md-6 row justify-content-between align-content-between mt-md-0 mt-3">
        <div class="col-md-12 pb-md-0 pb-3">
          <a href="" class="contact mt-5">Contact OurLending Team</a>
        </div>
        <div class="col-md-12 ">
  ...
  <div class="container">
    <div class="row justify-content-between">
      ...
      <div class="col-md-6 " style="border-left: 2px solid #e0dede;padding-left:4%;align-items: center;display: flex;">
        <h5> <em>The following transactions highlight a sampling of BOLOUR closings for retail, office, multi-family,
            industrial, mixed-use and urban infill land.</em></h5>
...
<section>
  ...
  <div id="popup1" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se1.jpg" alt="" width="100%">
  ...
  <div id="popup3" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se3.jpg" alt="" width="100%">
  ...
  <div id="popup4" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se4.jpg" alt="" width="100%">
  ...
  <div id="popup7" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se7.jpg" alt="" width="100%">
  ...
  <div id="popup8" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se8.jpg" alt="" width="100%">
  ...
  <div id="popup9" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se9.jpg" alt="" width="100%">
...
<div class="row">
  ...
  <div id="popup5" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se5.jpg" alt="" width="100%">
  ...
  <div id="popup2" class="popup">
    <div class="popup-content">
      ...
      <hr>
      <img src="assets/img/se2.jpg" alt="" width="100%">
      ...
      <p>4. Notice Drafting</p>

      <p>5. Representing the Corporate Debtors in NCLT hearing</p>
    ...
    <div class="row justify-content-between sses">
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Our professionals provide leading-edge services on systems, software, data analytics,
            automation and controls design and effectiveness, including related specialist services on external audit
            engagements.</p>
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Providing appropriate services under IBC Code for Corporate as well as Individual insolvency
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Formulate effective strategies to optimise taxes, implement innovative tax planning strategies
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Focus is the key & it's only possible when you focus completely on your core competencies and
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Experienced consulting in all aspects of labour law compliance and providing expert services
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Advisory & Compliance management services under RERA dealing with regulations & compliances
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Services at all stages of a business cycle, right from the inception of an entity to general
            corporate matters.</p>
      ...
      <div class="col-md-6 text-black row mt-5">
        ...
        <div class="col-md-8 mt-3">
          ...
          <p class="mt-3">Supporting you in future-proofing your business to become risk resilient and risk ready.</p>
